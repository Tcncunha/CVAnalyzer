...
def get_api_key(provider: str) -> str:
    ...
    if not cfg:
        raise EnvironmentError(f"Provider desconhecido: {provider}")
    ...
    if not key:
        ...
        raise EnvironmentError(
            ...
            f"Crie um arquivo .env na raiz do projeto com:\n\n"
            f"  {env_var}=sua-chave-aqui\n"
        )
    return key
...
# UI Constants
# ---------------------------------------------------------------------------
DEFAULT_PROFILE_LABEL = "-- Novo Perfil --"
...
- Write all fields in Portuguese (Brazil).
"""
